...
-- Optional total-conversion boot ids (content editor UI → data.gen2BootScreens).
local function gen2BootId(self, slot, default)
  local boot = self.data and self.data.gen2BootScreens
  local id = type(boot) == "table" and boot[slot]
...
function Game2:showOakSpeech()
  self.stack:clear()
  self.phase = "boot"
  Screens.push(self, gen2BootId(self, "newGame", "Gen2OakSpeech"), {
...
function Game2:showTitle()
  self.stack:clear()
  self.phase = "boot"
  Screens.push(self, gen2BootId(self, "title", "Gen2TitleState"), {
...
function Game2:showIntro()
  self.stack:clear()
  self.phase = "boot"
  Screens.push(self, gen2BootId(self, "movie", "Gen2GoldSilverIntro"), {
    onDone = function()
      self:showTitle()
    end,
  })
...
function Game2:showGameFreak()
  self.stack:clear()
  self.phase = "boot"
  Screens.push(self, gen2BootId(self, "gamefreak", "Gen2GameFreakPresents"), {
    title = self.titleData or {},
...
function Game2:showCopyright()
  self.stack:clear()
  self.phase = "boot"
  Screens.push(self, gen2BootId(self, "splash", "Gen2CopyrightSplash"), {
    title = self.titleData or {},
    onDone = function()
      self:showGameFreak()
    end,
...
function Game2:load()
  ...
  self:applyOptions()
  -- Same table on game.titleData and data.title / data.gen2Title so a
  -- mods.loaded writer (and the content editor) can patch art paths without
  -- a field registry — Schemas.GEN2 gates field.
  self.titleData = loadGenerated("data/generated/title.lua") or {}
  self.data.title = self.titleData
  self.data.gen2Title = self.titleData
  self.oakSpeechData = loadGenerated("data/generated/oak_speech.lua") or {}
  self.data.oakSpeech = self.oakSpeechData
  ...
  self.data.intro = self.data.gen2Intro
