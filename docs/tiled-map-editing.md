...
authoring without Tiled, use **Maps → New Map** in the Content Editor and see
[content-editor.md](content-editor.md#maps).
...
For an in-game map / Pokémon / item creator (and Pokemonium TMX import), see
